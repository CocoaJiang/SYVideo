...
#import "SYHotRankTableViewHeader.h"


@interface SYHotRankTableViewHeader ()
@property(strong,nonatomic)UIButton  *button;

@end
@implementation SYHotRankTableViewHeader
...
-(instancetype)initWithReuseIdentifier:(NSString *)reuseIdentifier andWithFamare:(CGRect)frame{
    if (self = [super initWithReuseIdentifier:reuseIdentifier]) {
        ...
        UIView *buttonView = [[UIView alloc]initWithFrame:CGRectMake(self.contentView.frame.size.width-(buttonWidth*3)-10, self.contentView.centerY-12.5, buttonWidth*3, 25)];
