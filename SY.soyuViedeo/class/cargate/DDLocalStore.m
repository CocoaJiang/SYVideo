...
- (void)saveSearchHistoryArrayToLocal:(NSArray *)historyStringArray {
    [[NSUserDefaults standardUserDefaults] setObject:historyStringArray forKey:@"SYhistoryStringArray"];
    [[NSUserDefaults standardUserDefaults] synchronize];
}

- (NSMutableArray *)getSearchHistoryArrayFromLocal{
    NSArray *historyStringArray = [[NSUserDefaults standardUserDefaults] objectForKey:@"SYhistoryStringArray"];
    historyStringArray = [NSMutableArray arrayWithArray:historyStringArray];
    return (NSMutableArray *)historyStringArray;
}
